...
return new Widget\WidgetConfig(array(
    ...
    'callback'      => function( $args, $instance ) {
        ...
        $show = explode(',', $instance['show']);
        $instance['show'] = array();
        foreach( $show as $asset )
        {
            $instance['show'][$asset] = true;
        }
        $instance['show']['replies'] = $instance['replies'] == 'ON';
        $instance['show']['retweets'] = $instance['retweets'] == 'ON';
