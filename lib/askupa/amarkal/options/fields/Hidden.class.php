...
class Hidden extends Field {
	...
	public function __construct($settings) {		$this->default_settings = array();		$this->pattern = '<input name="{name}" type="hidden" value="{value}" />';		$this->settings = $settings;		$this->init();
	}
