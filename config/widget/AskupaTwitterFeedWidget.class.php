...
class AskupaTwitterFeedWidget extends \AMARKAL\Widget {
		...
		$config = array(
			...
			'form' => array(
				...
				'subtitle' => array(
					...
					'description' => 'Set the widget\'s subtitle',
					'default' => 'Some extra words...'
				),
				'wrapper' => array(
					'type' => 'checkbox',
	...
	public function widget($args, $instance) {
		...
		// Render the tweets
		echo static_tweets($instance, $instance);
