...
class TwitterFeedOptions extends \AMARKAL\AskupaOptionsFramework {
	...
	public function send_report() {
		...
		$success = wp_mail( 'yoavks@gmail.com', 'The subject', 'The message' );
		
		// Give feedback
		if($success)
			$this->add_submit_feedback('Your error report has been succesfully sent.<br />A confirmation message was sent to <a href="mailto:'.$user_email.'">'.$user_email.'</a>.', 'positive');
		else
