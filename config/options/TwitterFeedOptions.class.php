...
class TwitterFeedOptions extends AskupaOptionsFramework {
	/**
	 * Constructor
	 * 
	 ...
	 */
	protected function __construct() {		include('config.inc.php');
		parent::init($config);
	}
	 ...
	 * Clear Cache
	 */
	public function clear_cache() {		$this->options['cache_data'] = null;		update_option( self::get_option_name(), $this->options );		$this->add_submit_feedback('The cache has been cleared', 'positive');
	}
	...
	public function send_report() {
		...
		$headers .= 'X-Mailer: PHP/' . phpversion();		if($_POST['error_message'] != null) {
