...
$config = array(
	...
	'header-icon-url' => PLUGIN_URL . 'assets/img/logo_white_64.png',
	'footer-text' => 'Askupa Software Options Framework for Wordpress',
	'footer-icon-url' => PLUGIN_URL . 'assets/img/logo_black_32.png',
	'sections' => $sections,
