...
$config['statictweets'] = array(
	...
	'shortcode' => '[statictweets skin="{skin}" dir="{dir}" resource="{resource}" user="{user}" list="{list}" query="{query}" count="{tweets}" show="username:{username},screenname:{screenname},avatar:{avatar},tweettime:{tweettime},tweetactions:{tweetactions},replies:{replies},retweets:{retweets}"/]',
);
